    ...
    internal class Alarm
    {
       ...
       public  List<House> Houses { get; set; }
        ...
        //now we need to know what was the time the event happened...
           ...
           //מכיון שעברנו לאובייקט מערכת צריך לשנות את החתימה
           public void SetAlarm(object sender, EventArgs args)
        {
            
            Console.Beep(350, 2000);
            Console.Beep(550, 1000);
            Console.WriteLine($"Alarm was SetOff on House number {((House) sender).houseNumber} and was setoff on {((DoorEventsArgs)args).eventTime}");
